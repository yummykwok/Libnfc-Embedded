...
static nfc_device *pn532_i2c_open(const nfc_context *context, const void* port);
...
static size_t pn532_i2c_scan(const nfc_context *context, const void* ports[], const size_t szPorts);
 ...
 */
static size_t
pn532_i2c_scan(const nfc_context *context,const void* ports[], const size_t szPorts)
{
  /*function under develpment*/
