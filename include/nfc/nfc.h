...
NFC_EXPORT void nfc_init() ATTRIBUTE_NONNULL(1);
NFC_EXPORT void nfc_exit() ATTRIBUTE_NONNULL(1);

/* NFC Device/Hardware manipulation */
NFC_EXPORT nfc_device *nfc_open(const USART_TypeDef* port) ATTRIBUTE_NONNULL(1);
NFC_EXPORT void nfc_close(nfc_device *pnd);
NFC_EXPORT int nfc_abort_command(nfc_device *pnd);
NFC_EXPORT size_t nfc_list_devices(const void* ports[], const size_t szPorts) ATTRIBUTE_NONNULL(1);
